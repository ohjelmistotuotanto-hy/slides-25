...
- **Verifiointi**: toteuttaako ohjelmisto vaatimusmäärittelyn aikana asetetut vaatimukset
  - Testataan toiminnalliset ja ei-toiminnalliset vaatimukset

. . .

- **Validointi**: täyttääkö ohjelmisto käyttäjän odotukset
  - Vaatimusmäärittelyn ei aina ole kirjattu sitä mitä käyttäjä todella tarvitsee

# Verifiointi ja Validointi

- Varmistetaan että ohjelma on _riittävän hyvä_ käyttötarkoitukseensa
...
- Katselmoinnin jälkeen määrittelydokumentti jäädytetään
  - muuttaminen vaatii yleensä monimutkaista prosessia
...
![](../ohjelmistotuotanto-hy.github.io/images/qlty1.png){ width=400 }

#

![](../ohjelmistotuotanto-hy.github.io/images/qlty3.png){ width=400 }
...
- Työn kulku on seuraava
  ...
  - Muutosten ollessa hyväksyttäviä pull request yhdistetään päärepositorioon
...
![](../ohjelmistotuotanto-hy.github.io/images/vibe4.png){ width=400 }

#

Copilot antaa myös detaljoidumpia kommentteja sekä parannusehdotuksia

![](../ohjelmistotuotanto-hy.github.io/images/vibe3.png){ width=400 }
...
- Toisin kuin Scrum, eXtreme Programming eli XP määrittelee useita sovelluskehityksen käytänteitä
  - Suuri osa näistä on hyvin tunnettuja parhaita käytänteitä, vietynä äärimmäiseen (extreme) muotoon

. . .

- Osa käytänteistä tähtää laadun maksimoimiseen, kolmen voidaan ajatella olevan katselmoinnin sukulaisia
...
- Hyvä oppimisen väline
  ...
  - järjestelmän tietyn osan tuntee aina useampi ohjelmoija
...
- Ohjelmiston osoittaminen virheettömäksi on mahdotonta
...
![](../ohjelmistotuotanto-hy.github.io/images/wave.png)
...
- Bugit parempi paikallistaa ajoissa vaiheessa
...
![](../ohjelmistotuotanto-hy.github.io/images/osa3-coverage.png){ width=400 }
...
- Integroinnin yhteydessä suoritetaan integrointitestaus
...
- Verkkokaupassa: sovelluslogiikan luokat, käyttöliittymän luokat ja tietokantarajapinta ensin omina kokonaisuuksinaan
...
- Esim. integroidaan kerrallaan kaikki storyn _lisää tuote ostoskoriin_ toteuttava koodi
