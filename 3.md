...
- Toiminnallisten vaatimusten dokumentointi voi tapahtua esim.
  ...
  - Ketterissä menetelmissä usein **user storyinä**
...
# Vaatimusmäärittely vesiputouksen aikakaudella
...
# Vaatimusmäärittely vesiputouksen aikakaudella: vaikeaa
...
# Vaatimusmäärittely iteratiivisessa ja ketterässä ohjelmistokehityksessä
...
- Jos idea on hyvä, toteutetaan sen toiminnallisuus robustilla tavalla
  - jos ei, palataan järjestelmän edelliseen versioon
...
- User storyt kuvaavat loppukäyttäjän kannalta arvokkaita toiminnallisuuksia
...
- Storyyn kuuluvia testejä kutsutaan **hyväksymätesteiksi** tai **hyväksymäkriteereiksi**
...
- User story tulisi kuvata "end to end"-toiminnallisuutta
  - kattaen käyttöliittymän, bisneslogiikan, ja tietokannan
...
- **Testability**: storyille pitää pystyä laatimaan kriteerit, joiden avulla voi todeta onko story toteutettu hyväksyttävästi
...
- Projektin alussa etsitään ja määrittelellään user storyja ja muodostaa näistä alustava product backlog
