...
- Sykli ominaisuuden määrittelystä sen ohjelmointiin ja testaukseen on erittäin lyhyt

. . .

- Testausta sprintin "ensimmäisestä päivästä" lähtien, testaus integroitu suunnitteluun ja toteutukseen
...
1. Kirjoitetaan testi, joka ei mene läpi
...
- Käytetään joskus nimitystä _Acceptance test driven development_ (ATDD) tai _Behavior driven development_ (BDD)
...
- Jokainen kehittäjä integroi koodinsa muuhun koodiin mahdollisimman usein, vähintään kerran päivässä

. . .

- CI rohkaisee jakamaan työn pieniin osiin, jotka saadaan testeineen valmiiksi yhden työpäivän aikana
